...
Description: Here we are validating following system calls to the file system.
do_mkdir, do_rmdir, do_chdir, do_link, do_unlink, do_lseek, do_open, do_read, do_write, do_close, do_dup do_dup2. At the end of execution we launch the kshell. The grader can validate the result from the logs as well as in the kshell.
